						...
						<div class="l-container is--2col">
							...
							<section class="p-people__employee__article__chapter">
								...
								<div class="p-people__employee__article__chapter__body">
									<p>大学院卒業後は、2社の設計事務所を経て、久米設計に入社しました。1社目は個人住宅をメインとしたアトリエ設計事務所。その後に勤めたのは、集合住宅をそこに住み続けてきた人の思いを汲み取りながら新たな魅力を備えたものに建て替えるような計画を得意とする設計事務所でした。この2社でも、やりがいは感じていましたが、経験を積み重ねる中で、より幅広いプロジェクトにも携わってみたいと思うようになったのが転職の理由です。久米設計は、社内で構造設計や設備設計を含めたチームができこまめにコミュニケーションが取れるので、仕事のしやすさを日々感じています。</p>
								</div>
							</section>
