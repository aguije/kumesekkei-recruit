						...
						<div class="l-container is--2col">
							...
							<section class="p-people__employee__article__chapter">
								...
								<div class="p-people__employee__article__chapter__body">
									<p>大学院卒業後は、2社のアトリエ設計事務所を経て、久米設計に入社しました。1社目は個人住宅をメインとした設計事務所。その後に勤めたのは、集合住宅をそこに住み続けてきた人の思いを汲み取りながら新たな魅力を備えたものに建て替えるような計画を得意とする設計事務所でした。この2社でも、やりがいは感じていましたが、経験を積み重ねる中で、より幅広いプロジェクトにも携わってみたいと思うようになったのが転職の理由です。久米設計は、社内で構造設計や設備設計を含めたチームができこまめにコミュニケーションが取れるので、仕事のしやすさを日々感じています。</p>
								</div>
							</section>
							...
							<section class="p-people__employee__article__chapter">
								...
								<div class="p-people__employee__article__chapter__body">
									<p>久米設計では、これまでの経験を生かして住宅機能を持つ複合施設を担当することが多いのですが、数年前にホテルを併設した複合施設案件に声をかけていただいたことがきっかけで、ホテルも担当するようになりました。住宅もホテルも、利用する人がどのように空間でのひとときを過ごすのか想像を巡らせて、時間を経るごとに魅力が増していくようなものを目指したいと思いながら設計をしています。引き続き得意分野は生かしつつ、新たなタイプのプロジェクトにも挑戦していきたいです。</p>
								</div>
							</section>
						</div>
					</div>
					...
					<section class="p-people__employee__article__chapter">
						<div class="l-wrapper">
							<div class="l-container--narrow">
								...
								<div class="p-people__employee__article__chapter__body">
									<p>複合施設やホテル設計は、社内外を含めて関わる人が多いのが特徴的。設計を進める上で、それぞれが考えている内容を把握し、調整し、統合する必要があるため、住宅単体のプロジェクトとは異なる大変さがあります。心がけているのは、何事も柔軟性を持って対応できる余白を持って対応すること。技術的に難しい課題が出てきた際にも、プロジェクト全体にとって最善の方法が見出せるように時間の許す限り検討するようにしています。頭を悩ませることもありますが、そんな役割にも自信が持てるようになってきた気がします。</p>
								</div>
							</div>
						</div>
					</section>
						...
						<div class="l-wrapper">
							<div class="l-container is--2col">
								<div>
									...
									<div class="p-people__employee__article__chapter__body">
										<p>設計は90%が地味な作業ですし、時には困難も伴います。でも、図面やパースが現実の形になって建ち上がり、様々な人に利用され社会的にも注目していただけると、何にも変え難い大きな達成感と喜びに包まれます。そういうチャンスをぜひここで積極的に掴んでください。</p>
									</div>
								</div>
