						...
						<div class="l-container">
							<div class="p-people__employee__article__header__title">
								...
								<p class="p-people__employee__article__header__message">
									<span><span class="is--line">安全性はもちろん見た目にも美しい、</span><span class="is--line">意匠に寄り添った構造設計を目指して。</span>
								</p>
							</div>
							<div class="p-people__employee__article__header__body">
								...
								<div>
									...
									<div class="p-people__employee__article__header__profile">
										<p>2003年入社<br>
										構造設計</p>
										<p class="p-people__employee__article__header__description">入社以降、体育館から飲食店まで、幅広いジャンルの建物にて構造設計に携わる。安全性と見た目の美しさを兼ね備えた構造設計を目指す。第33回JSCA賞にて作品賞を受賞。</p>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="l-container is--2col">
							...
							<section class="p-people__employee__article__chapter">
								<header class="p-people__employee__article__chapter__header">
									...
									<h2>体育館構造への意欲は<br class="is--pc">伝え続けて経験にする</h2>
								</header>

								<div class="p-people__employee__article__chapter__body">
									<p>大学院では、体育館など非常に大きな空間の構造設計を研究していたので、卒業後もそのような案件に携わることができる設計事務所を希望していました。当時は就職氷河期で構造設計での募集は少なかったのですが、久米設計の会社案内に掲載されている事例に、様々な建築物に携わることができそうな期待感が膨らみ、ここで働きたいという気持ちが強くなりました。当時は体育館の案件は少なかったのですが、やりたい意思を伝え続けることで声をかけてもらえるようになり、今では経験者として相談していただくことが多くなりました。</p>
								</div>
							</section>
							...
							<section class="p-people__employee__article__chapter">
								<header class="p-people__employee__article__chapter__header">
									<p lang="en">CHAPTER <b></b></p>
									<h2>安全性を守りつつ寄り添う<br class="is--pc">建築美を叶えたい</h2>
								</header>

								<div class="p-people__employee__article__chapter__body">
									<p>構造設計としては、もちろん安全性が第一。しかし、居心地のよさや使い勝手の良さ、また建築物としての美しさも成立させることも大切だと、私は考えます。意匠設計チームから上がる様々なリクエストの中には、耐震を考えるとそのまま反映することは難しい場合もあり、時に意見を戦わせることもしばしばですが、私は極力「できない」とは言わないようにしています。諦めずに設計者とことん話し合い、意図を汲んで本質を読み取ると、別の方法を提案できることがあります。その調整が大変なところですが、大きなやりがいでもあります。</p>
								</div>
							</section>
						</div>
					</div>
					...
					<section class="p-people__employee__article__chapter">
						<div class="l-wrapper">
							<div class="l-container--narrow">
								...
								<div class="p-people__employee__article__chapter__body">
									<p>耐震技術や建築資材は日々進化し続けています。学会に参加するなどして最新の情報を収集したり、フィットする案件があれば積極的に最新技術を取り入れたり、常にアンテナを張って新しいことにチャレンジしていくことも大切です。新しいものへの関心と同様に、カーボンニュートラルの観点からも注目されている木造建築への取り組みも、これからさらに学びを深め経験を積み重ねていきたいところです。社内でも定期的に「都市木造ワーキング」という勉強会を開催しています。ますます知見を広げて、新しい挑戦を続けて行けたらと思います。</p>
								</div>
							</div>
						</div>
					</section>
											...
											<div id="tab2" class="swiper-slide">
												...
												<div class="swiper-slide__container">
													...
													<div class="swiper-slide__body">
														<p>子どもを連れて構造を担当した建物へ。建築に興味を持ってくれたらいいなと願いながら。</p>
													</div>
												</div>
											</div>
										</div>
