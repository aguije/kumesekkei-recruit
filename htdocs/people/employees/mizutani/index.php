						...
						<div class="l-container is--2col">
							...
							<section class="p-people__employee__article__chapter">
								...
								<div class="p-people__employee__article__chapter__body">
									<p>大学のOBが久米設計で働いていたことをきっかけに興味を持ち、会社見学をさせていただきました。その時に、社員みなさんの雰囲気の良さが印象的で、ここで一緒に仕事をしたいと思ったのが志望動機です。</p>
									<p>振り返ると、大学院時代にフランスでの都市型ワークショップに参加したのはよい経験になりましたし、⻑期休暇を利用した海外旅行で見ることができ た様々な建築物には、今でも刺激をもらいますし参考にすることがあります。特に印象に残っているのは、増築を繰り返しているルイジアナ美術館。また訪れたい場所です。</p>
								</div>
							</section>
							...
							<section class="p-people__employee__article__chapter">
								<header class="p-people__employee__article__chapter__header">
									<p lang="en">CHAPTER <b></b></p>
									<h2>公共施設の設計を通じて<span class="u-inline-block">社会貢献をしていきたい</span></h2>
								</header>

								<div class="p-people__employee__article__chapter__body">
									<p>現在は、博物館や美術館など、様々な公共施設の意匠設計を担当させていただいています。公共の施設をいくつか担当させていただいて、以前よりも社会貢献を強く意識するようになりました。</p>
									<p>このように人々に開かれた施設の設計は、単に建物を作るというだけでなく、そこを利用する人に影響を与え、社会にも影響を与えていけるものだと考えています。建物を起点に起こる様々なプラスの可能性を考えながら、柔軟にアイデアを膨らませてご提案ができたらいいなと思っています。</p>
								</div>
							</section>
						</div>
					</div>
					...
					<section class="p-people__employee__article__chapter">
						<div class="l-wrapper">
							<div class="l-container--narrow">
								...
								<div class="p-people__employee__article__chapter__body">
									<p>2022年5月から1年間の産休育休を取りました。復帰する直前は今まで通りに仕事ができるか不安はありましたが、現在はやっとペースを掴むことができ、以前と変わらずに案件に携わっています。ただ、時短勤務で以前より作業時間が限られるので、できるだけ前倒しで取り組むように心がけています。</p>
						...
						<div class="l-wrapper">
							<div class="l-container is--2col">
								<div>
									...
									<div class="p-people__employee__article__chapter__body">
										<p>日頃から、自分だったらどうするか、どう考えるかを真剣に考えてみるようにしています。手を動かして、行動から良い方法を見つけようとすることもあります。</p>
